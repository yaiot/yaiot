...
4. телеграм-бот умеет в авторизацию OAuth (см. ниже), этот токен должен браться из базы данных
5. в телеграм-боте должна быть возможность добавлять новые умные лампочки в систему (командой добавления)
6. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTY3ODcyNTE3LDE5MzQ2OTI5MywxNjQzNz
A0NzkxXX0=
-->